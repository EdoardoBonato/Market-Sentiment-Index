# -*- coding: utf-8 -*-
"""
Created on Mon Dec  4 18:47:30 2023
...
#construct the final dataset for the index
...
# impute standard deviation when value equals zero
index_std = 'index_std'
...
#calculate index mean and std at the sector level
index_mean = []
...
#export all to excel
file_path_1 = r'C:\Users\edobo\OneDrive\Desktop\THINGS TO SEND\EBIT_balanced_index_with_outliers.xlsx'
...
fig1.update_layout(title_text = "Automotive: profitability_eu,  balanced panel, weighted")
fig1.update_layout(yaxis = dict( range=[0, 150], dtick = 20))
fig1.write_html(r'C:\your_path\profitability_weighted_EU.html')
