# -*- coding: utf-8 -*-
"""
Created on Wed Nov 29 10:06:37 2023
...
path_us = r"C:\your_path\cost_USA_balanced_index.xlsx"
path_eu = r"C:\your_path\cost_EU_balanced_index.xlsx"
...
fig1.update_layout(title_text = "Automotive cost: us and eu, balanced sample, weighted")
fig1.update_layout(yaxis = dict( range=[0, 150], dtick = 20))
fig1.write_html(r'C:\your_path\automobiles_cost_eu_us_balanced.html')
