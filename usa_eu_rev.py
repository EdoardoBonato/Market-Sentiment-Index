# -*- coding: utf-8 -*-
"""
Created on Tue Nov 28 15:14:18 2023
...
path_eu = r"C:\your_path\revenue_EU_balanced_index.xlsx"
...
x = list(index_us.loc['year_weighted'])
x_rev = list(index_us.loc['year_weighted'][::-1])
...
fig1.update_layout(title_text = "Automotive revenue: us and eu, balanced sample, weighted")
fig1.update_layout(yaxis = dict( range=[0, 150], dtick = 20))
fig1.write_html(r'C:\your_path\automobiles_revenue_eu_us_balanced.html')
